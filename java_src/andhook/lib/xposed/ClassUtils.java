...
public class ClassUtils {
    ...
    public static ArrayList<Class<?>> convertClassNamesToClasses(List<String> list) {
        if (list == null) {
            return null;
        }
        ArrayList<Class<?>> arrayList = new ArrayList<>(list.size());
        for (String str : list) {
            try {
    ...
    public static Method getPublicMethod(Class<?> cls, String str, Class<?>... clsArr) throws SecurityException, NoSuchMethodException {
        ...
        throw new NoSuchMethodException("Can't find a public method for " + str + " " + clsArr.toString());
    }
