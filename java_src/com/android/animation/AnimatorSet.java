...
public final class AnimatorSet extends Animator {
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new AnimatorListenerAdapter() { // from class: com.android.animation.AnimatorSet.1
    ...
    @Override // com.android.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo13758clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo13758clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m13759clone = next.m13759clone();
            hashMap.put(next, m13759clone);
            animatorSet.mNodes.add(m13759clone);
            animatorSet.mNodeMap.put(m13759clone.animation, m13759clone);
            m13759clone.dependencies = null;
            m13759clone.tmpDependencies = null;
            m13759clone.nodeDependents = null;
            m13759clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m13759clone.animation.getListeners();
            if (listeners != null) {
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m13759clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo13758clone();
                return node;
