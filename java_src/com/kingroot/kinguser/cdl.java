...
public class cdl {
    ...
    /* renamed from: a */
    private static byte[] m4831a(byte[] bArr) {
    ...
    /* renamed from: a */
    public static byte[] m4830a(byte[] bArr, byte[] bArr2) {
        byte[] m4831a = m4831a(bArr2);
        if (bArr == null || m4831a == null || bArr.length == 0) {
            return bArr;
        }
        ...
        int length2 = m4831a.length % 4 == 0 ? m4831a.length >>> 2 : (m4831a.length >>> 2) + 1;
        if (length2 < 4) {
            length2 = 4;
        }
    ...
    /* renamed from: b */
    public static byte[] m4829b(byte[] bArr, byte[] bArr2) {
        byte[] m4831a = m4831a(bArr2);
        if (bArr == null || m4831a == null || bArr.length == 0) {
            return bArr;
        }
        ...
        m4828c(bArr, iArr);
        int length = m4831a.length % 4 == 0 ? m4831a.length >>> 2 : (m4831a.length >>> 2) + 1;
        if (length < 4) {
            length = 4;
        }
        ...
        m4827c(iArr, iArr.length - 1, bArr3);
        return bArr3;
    }

    /* renamed from: c */
    private static void m4828c(byte[] bArr, int[] iArr) {
        int i = 0;
    ...
    /* renamed from: c */
    private static void m4827c(int[] iArr, int i, byte[] bArr) {
        int length = bArr.length >> 2;
        if (length > i) {
            length = i;
        }
