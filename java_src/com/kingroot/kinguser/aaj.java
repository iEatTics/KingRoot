...
public class aaj {
    ...
    /* renamed from: a */
    private static void m12996a(byte[] bArr, int[] iArr) {
        int i = 0;
    ...
    /* renamed from: a */
    private static void m12995a(int[] iArr, int i, byte[] bArr) {
        int length = bArr.length >> 2;
        if (length > i) {
            length = i;
        }
    ...
    /* renamed from: H */
    public static byte[] m12997H(byte[] bArr) {
    ...
    /* renamed from: c */
    public static byte[] m12994c(byte[] bArr, byte[] bArr2) {
        byte[] m12997H = m12997H(bArr2);
        if (bArr != null && m12997H != null && bArr.length != 0) {
            int length = bArr.length % 4 == 0 ? (bArr.length >>> 2) + 1 : (bArr.length >>> 2) + 2;
            int[] iArr = new int[length];
            m12996a(bArr, iArr);
            iArr[length - 1] = bArr.length;
            int length2 = m12997H.length % 4 == 0 ? m12997H.length >>> 2 : (m12997H.length >>> 2) + 1;
            if (length2 < 4) {
                length2 = 4;
            }
            ...
            while (true) {
                ...
                if (i4 > 0) {
                    ...
                    m12995a(iArr, iArr.length, bArr3);
                    return bArr3;
                }
            }
        } else {
    ...
    /* renamed from: n */
    public static byte[] m12991n(byte[] bArr) {
        return m12994c(bArr, m12990pL());
    }

    /* renamed from: d */
    public static byte[] m12993d(byte[] bArr, byte[] bArr2) {
        byte[] m12997H = m12997H(bArr2);
        if (bArr != null && m12997H != null && bArr.length != 0) {
            ...
            m12996a(bArr, iArr);
            int length = m12997H.length % 4 == 0 ? m12997H.length >>> 2 : (m12997H.length >>> 2) + 1;
            if (length < 4) {
                length = 4;
            }
            ...
            m12995a(iArr, iArr.length - 1, bArr3);
            return bArr3;
        }
        return bArr;
    }
    ...
    /* renamed from: m */
    public static byte[] m12992m(byte[] bArr) {
        return m12993d(bArr, m12990pL());
    }
}
