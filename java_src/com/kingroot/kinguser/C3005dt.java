...
/* renamed from: com.kingroot.kinguser.dt */
/* loaded from: classes.dex */
public final class C3005dt extends JceStruct {

    /* renamed from: lw */
    static C2859df f2506lw;
    ...
    public void readFrom(JceInputStream jceInputStream) {
        ...
        this.softkey = (C2859df) jceInputStream.read((JceStruct) f2506lw, 10, true);
        ...
        this.backendExtendInfo = jceInputStream.read(f2507nL, 35, false);
        if (f2508nM == null) {
            f2508nM = new byte[1];
            f2508nM[0] = 0;
        }
        this.frontendExtendInfo = jceInputStream.read(f2508nM, 36, false);
    }
}
