...
public class bnk {
    ...
    /* renamed from: a */
    private static void m6232a(byte[] bArr, int[] iArr) {
        int i = 0;
    ...
    /* renamed from: a */
    private static void m6231a(int[] iArr, int i, byte[] bArr) {
        int length = bArr.length >> 2;
        if (length > i) {
            length = i;
        }
    ...
    /* renamed from: H */
    private static byte[] m6233H(byte[] bArr) {
    ...
    /* renamed from: c */
    public static byte[] m6230c(byte[] bArr, byte[] bArr2) {
        byte[] m6233H = m6233H(bArr2);
        if (bArr != null && m6233H != null && bArr.length != 0) {
            int length = bArr.length % 4 == 0 ? (bArr.length >>> 2) + 1 : (bArr.length >>> 2) + 2;
            int[] iArr = new int[length];
            m6232a(bArr, iArr);
            iArr[length - 1] = bArr.length;
            int length2 = m6233H.length % 4 == 0 ? m6233H.length >>> 2 : (m6233H.length >>> 2) + 1;
            if (length2 < 4) {
                length2 = 4;
            }
    ...
    /* renamed from: d */
    public static byte[] m6229d(byte[] bArr, byte[] bArr2) {
        byte[] m6233H = m6233H(bArr2);
        if (bArr != null && m6233H != null && bArr.length != 0) {
            ...
            m6232a(bArr, iArr);
            int length = m6233H.length % 4 == 0 ? m6233H.length >>> 2 : (m6233H.length >>> 2) + 1;
            if (length < 4) {
                length = 4;
            }
            ...
            m6231a(iArr, iArr.length - 1, bArr3);
            return bArr3;
        }
        return bArr;
    }
