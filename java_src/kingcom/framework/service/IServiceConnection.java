package kingcom.framework.service;
...
public interface IServiceConnection extends IInterface {
    void connected(IBinder iBinder);

    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements IServiceConnection {
        private static final String DESCRIPTOR = "kingcom.framework.service.IServiceConnection";
        ...
        /* loaded from: classes.dex */
        static class Proxy implements IServiceConnection {
            ...
            @Override // kingcom.framework.service.IServiceConnection
