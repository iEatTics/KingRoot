...
import android.support.p004v4.app.FragmentTransitionCompat21;
import android.support.p004v4.util.ArrayMap;
import android.support.p004v4.util.LogWriter;
...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
    ...
    /* loaded from: classes.dex */
    public static final class C0030Op {
        int cmd;
        int enterAnim;
        int exitAnim;
        Fragment fragment;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (this.mHead != null) {
            ...
            while (c0030Op != null) {
                ...
                printWriter.print(" ");
                printWriter.println(c0030Op.fragment);
                if (z) {
                    if (c0030Op.enterAnim != 0 || c0030Op.exitAnim != 0) {
                        printWriter.print(str);
                        printWriter.print("enterAnim=#");
                        printWriter.print(Integer.toHexString(c0030Op.enterAnim));
                        printWriter.print(" exitAnim=#");
                        printWriter.println(Integer.toHexString(c0030Op.exitAnim));
                    }
                    if (c0030Op.popEnterAnim != 0 || c0030Op.popExitAnim != 0) {
                        printWriter.print(str);
                        printWriter.print("popEnterAnim=#");
                        printWriter.print(Integer.toHexString(c0030Op.popEnterAnim));
                        printWriter.print(" popExitAnim=#");
                        printWriter.println(Integer.toHexString(c0030Op.popExitAnim));
                    }
                }
                if (c0030Op.removed != null && c0030Op.removed.size() > 0) {
                    for (int i2 = 0; i2 < c0030Op.removed.size(); i2++) {
                        printWriter.print(str3);
                        if (c0030Op.removed.size() == 1) {
                        ...
                        printWriter.println(c0030Op.removed.get(i2));
                    }
                }
                c0030Op = c0030Op.next;
                i++;
            }
        }
    }
    ...
    @Override // android.support.p004v4.app.FragmentManager.BackStackEntry
    public int getId() {
        return this.mIndex;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addOp(C0030Op c0030Op) {
        if (this.mHead == null) {
            this.mTail = c0030Op;
            this.mHead = c0030Op;
        } else {
            c0030Op.prev = this.mTail;
            this.mTail.next = c0030Op;
            this.mTail = c0030Op;
        }
        c0030Op.enterAnim = this.mEnterAnim;
        c0030Op.exitAnim = this.mExitAnim;
        c0030Op.popEnterAnim = this.mPopEnterAnim;
        c0030Op.popExitAnim = this.mPopExitAnim;
        this.mNumOp++;
    }

    @Override // android.support.p004v4.app.FragmentTransaction
    ...
    private void doAddOp(int i, Fragment fragment, String str, int i2) {
        ...
        C0030Op c0030Op = new C0030Op();
        c0030Op.cmd = i2;
        c0030Op.fragment = fragment;
        addOp(c0030Op);
    }
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (C0030Op c0030Op = this.mHead; c0030Op != null; c0030Op = c0030Op.next) {
                if (c0030Op.fragment != null) {
                    c0030Op.fragment.mBackStackNesting += i;
                    if (FragmentManagerImpl.DEBUG) {
                        Log.v(TAG, "Bump nesting of " + c0030Op.fragment + " to " + c0030Op.fragment.mBackStackNesting);
                    }
                }
                if (c0030Op.removed != null) {
                    for (int size = c0030Op.removed.size() - 1; size >= 0; size--) {
                        Fragment fragment = c0030Op.removed.get(size);
    ...
    public void run() {
        ...
        for (C0030Op c0030Op = this.mHead; c0030Op != null; c0030Op = c0030Op.next) {
            int i3 = transitionState != null ? 0 : c0030Op.enterAnim;
            int i4 = transitionState != null ? 0 : c0030Op.exitAnim;
            switch (c0030Op.cmd) {
                case 1:
                    Fragment fragment2 = c0030Op.fragment;
                    fragment2.mNextAnim = i3;
                    this.mManager.addFragment(fragment2, false);
                    break;
                case 2:
                    Fragment fragment3 = c0030Op.fragment;
                        ...
                        while (size >= 0) {
                            ...
                            if (fragment4.mContainerId == i5) {
                                if (fragment4 == fragment3) {
                                    ...
                                    if (c0030Op.removed == null) {
                                        c0030Op.removed = new ArrayList<>();
                                    }
                                    c0030Op.removed.add(fragment4);
    ...
    private void calculateFragments(SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        if (this.mManager.mContainer.onHasView()) {
            for (C0030Op c0030Op = this.mHead; c0030Op != null; c0030Op = c0030Op.next) {
                switch (c0030Op.cmd) {
                    case 1:
                        setLastIn(sparseArray, sparseArray2, c0030Op.fragment);
                        break;
                    case 2:
                        Fragment fragment = c0030Op.fragment;
                        if (this.mManager.mAdded != null) {
                            int i = 0;
                        ...
                        break;
                    case 3:
                        setFirstOut(sparseArray, sparseArray2, c0030Op.fragment);
                        break;
                    case 4:
                        setFirstOut(sparseArray, sparseArray2, c0030Op.fragment);
                        break;
    ...
    public void calculateBackFragments(SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        if (this.mManager.mContainer.onHasView()) {
            for (C0030Op c0030Op = this.mTail; c0030Op != null; c0030Op = c0030Op.prev) {
                switch (c0030Op.cmd) {
                    case 1:
                        setFirstOut(sparseArray, sparseArray2, c0030Op.fragment);
                        break;
                    case 2:
                        if (c0030Op.removed != null) {
                            for (int size = c0030Op.removed.size() - 1; size >= 0; size--) {
                                setLastIn(sparseArray, sparseArray2, c0030Op.removed.get(size));
                            }
                        }
                        setFirstOut(sparseArray, sparseArray2, c0030Op.fragment);
                        break;
    ...
    public TransitionState popFromBackStack(boolean z, TransitionState transitionState, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        int i2 = transitionState != null ? 0 : this.mTransition;
        for (C0030Op c0030Op = this.mTail; c0030Op != null; c0030Op = c0030Op.prev) {
            int i3 = transitionState != null ? 0 : c0030Op.popEnterAnim;
            int i4 = transitionState != null ? 0 : c0030Op.popExitAnim;
            switch (c0030Op.cmd) {
                case 1:
                    Fragment fragment = c0030Op.fragment;
                ...
                case 2:
                    ...
                    if (c0030Op.removed != null) {
                        for (int i5 = 0; i5 < c0030Op.removed.size(); i5++) {
                            Fragment fragment3 = c0030Op.removed.get(i5);
                            fragment3.mNextAnim = i3;
                            this.mManager.addFragment(fragment3, false);
                        }
                        break;
                ...
                case 3:
                    Fragment fragment4 = c0030Op.fragment;
        ...
        if (sharedElementTransition != null) {
            ...
            if (arrayMap.isEmpty()) {
                ...
                FragmentTransitionCompat21.ViewRetriever viewRetriever = new FragmentTransitionCompat21.ViewRetriever() { // from class: android.support.v4.app.BackStackRecord.1
                    @Override // android.support.p004v4.app.FragmentTransitionCompat21.ViewRetriever
                    public View getView() {
