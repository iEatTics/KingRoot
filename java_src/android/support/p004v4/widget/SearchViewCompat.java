...
import android.support.p004v4.widget.SearchViewCompatHoneycomb;
...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatStubImpl implements SearchViewCompatImpl {
        ...
        @Override // android.support.p004v4.widget.SearchViewCompat.SearchViewCompatImpl
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        @Override // android.support.p004v4.widget.SearchViewCompat.SearchViewCompatStubImpl, android.support.p004v4.widget.SearchViewCompat.SearchViewCompatImpl
        public View newSearchView(Context context) {
        ...
        public Object newOnQueryTextListener(final OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new SearchViewCompatHoneycomb.OnQueryTextListenerCompatBridge() { // from class: android.support.v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl.1
                @Override // android.support.p004v4.widget.SearchViewCompatHoneycomb.OnQueryTextListenerCompatBridge
        ...
        public Object newOnCloseListener(final OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new SearchViewCompatHoneycomb.OnCloseListenerCompatBridge() { // from class: android.support.v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl.2
                @Override // android.support.p004v4.widget.SearchViewCompatHoneycomb.OnCloseListenerCompatBridge
    ...
    static class SearchViewCompatIcsImpl extends SearchViewCompatHoneycombImpl {
        ...
        @Override // android.support.p004v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl, android.support.p004v4.widget.SearchViewCompat.SearchViewCompatStubImpl, android.support.p004v4.widget.SearchViewCompat.SearchViewCompatImpl
        public View newSearchView(Context context) {
