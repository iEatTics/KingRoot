...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild, NestedScrollingParent, ScrollingView {
    ...
    @Override // android.view.ViewGroup, android.view.ViewParent, android.support.p004v4.view.NestedScrollingParent
    ...
    @Override // android.view.ViewGroup, android.support.p004v4.view.NestedScrollingParent
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.mScrollOffset)) {
                            ...
                            int i3 = scrollY + i;
                            if (i3 < 0) {
                                this.mEdgeGlowTop.onPull(i / getHeight(), MotionEventCompat.getX(motionEvent, findPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i3 > scrollRange) {
                                this.mEdgeGlowBottom.onPull(i / getHeight(), 1.0f - (MotionEventCompat.getX(motionEvent, findPointerIndex) / getWidth()));
