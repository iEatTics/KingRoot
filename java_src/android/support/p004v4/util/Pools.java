package android.support.p004v4.util;
...
public final class Pools {
    ...
    public static class SimplePool<T> implements Pool<T> {
        ...
        @Override // android.support.p004v4.util.Pools.Pool
        public T acquire() {
            if (this.mPoolSize > 0) {
    ...
    public static class SynchronizedPool<T> extends SimplePool<T> {
        ...
        @Override // android.support.p004v4.util.Pools.SimplePool, android.support.p004v4.util.Pools.Pool
        public T acquire() {
            T t;
