...
import android.support.p004v4.media.MediaBrowserCompatApi24;
...
public final class MediaBrowserCompat {
    ...
    public static class ConnectionCallback {
        ...
        class StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
            ...
            @Override // android.support.p004v4.media.MediaBrowserCompatApi21.ConnectionCallback
            public void onConnected() {
    ...
    public static abstract class SubscriptionCallback {
        ...
        class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            @Override // android.support.p004v4.media.MediaBrowserCompatApi21.SubscriptionCallback
            public void onChildrenLoaded(@NonNull String str, List<Parcel> list) {
                ...
                List<MediaItem> parcelListToItemList = parcelListToItemList(list);
        ...
        class StubApi24 extends StubApi21 implements MediaBrowserCompatApi24.SubscriptionCallback {
            ...
            @Override // android.support.p004v4.media.MediaBrowserCompatApi24.SubscriptionCallback
    ...
    public static abstract class ItemCallback {
        ...
        class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
            ...
            @Override // android.support.p004v4.media.MediaBrowserCompatApi23.ItemCallback
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override // android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void connect() {
            if (this.mState == 0) {
        ...
        @Override // android.support.p004v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallback.ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override // android.support.p004v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
        public void onConnected() {
            IBinder binder;
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        @Override // android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (this.mServiceBinderWrapper == null) {
    ...
    static class MediaBrowserImplApi24 extends MediaBrowserImplApi23 {
        ...
        @Override // android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImplApi23, android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.p004v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            MediaBrowserCompatApi23.getItem(this.mBrowserObj, str, itemCallback.mItemCallbackObj);
        }
    }
    ...
    public static class ItemReceiver extends ResultReceiver {
        ...
        @Override // android.support.p004v4.p006os.ResultReceiver
