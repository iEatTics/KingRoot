...
import android.support.p004v4.view.NestedScrollingChild;
import android.support.p004v4.view.NestedScrollingChildHelper;
import android.support.p004v4.view.ScrollingView;
...
import android.support.p007v7.widget.AdapterHelper;
import android.support.p007v7.widget.ChildHelper;
import android.support.p007v7.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: android.support.v7.widget.RecyclerView.4
            @Override // android.support.p007v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0219R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0219R.styleable.RecyclerView_layoutManager);
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.5
            @Override // android.support.p007v7.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.6
            @Override // android.support.p007v7.widget.AdapterHelper.Callback
    ...
    @Override // android.view.View, android.support.p004v4.view.ScrollingView
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0219R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0219R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0219R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0219R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0219R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    @Override // android.view.View, android.support.p004v4.view.NestedScrollingChild
    ...
    class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p007v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
