...
import android.support.p004v4.widget.ResourceCursorAdapter;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
        super(context, C0189R.layout.abc_search_dropdown_item_icons_2line, (Cursor) null, true);
        this.mClosed = false;
    ...
    @Override // android.support.p004v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    public boolean hasStableIds() {
        return false;
    }

    @Override // android.support.p004v4.widget.CursorAdapter, android.support.p004v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p004v4.widget.ResourceCursorAdapter, android.support.p004v4.widget.CursorAdapter
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0189R.C0191id.edit_query);
        }
    }

    @Override // android.support.p004v4.widget.CursorAdapter
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0189R.attr.textColorSearchUrl, typedValue, true);
    ...
    @Override // android.support.p004v4.widget.CursorAdapter, android.widget.Adapter
