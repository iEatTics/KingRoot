...
public class MenuBuilder implements SupportMenu {
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2 = true;
        this.mShortcutsVisible = (z && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0189R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) ? false : false;
    }
    ...
    public boolean performItemAction(MenuItem menuItem, int i) {
        ...
        if (menuItemImpl.hasCollapsibleActionView()) {
            ...
            boolean dispatchSubMenuSelected = dispatchSubMenuSelected(subMenuBuilder) | invoke;
