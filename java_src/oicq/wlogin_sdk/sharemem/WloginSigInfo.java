...
public class WloginSigInfo implements Parcelable, Serializable {
    ...
    public WloginSigInfo Set(byte[][] bArr, long j) {
        if (bArr != null && bArr.length == 5) {
            ...
            if (bArr[2] != null && bArr[2].length > 0) {
                this.f5318_G = (byte[]) bArr[2].clone();
            }
    ...
    public void SetSigInfo(long j, long j2, long j3, long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7, byte[] bArr8, byte[] bArr9, byte[] bArr10, byte[] bArr11, byte[] bArr12, byte[][] bArr13, long[] jArr, int i) {
        ...
        if (bArr13 == null || bArr13.length != 15) {
            C4393util.LOGI("ERROR:reserve null or length not right", "");
        } else if (jArr == null || jArr.length != 7) {
            C4393util.LOGI("reserve_valid null or length not right", "");
        } else {
            this._app_pri = j;
            ...
            if (this._DA2 == null) {
                C4393util.LOGI("_DA2 is null", "");
                length = 0;
            } else {
                length = this._DA2.length;
            }
            if (bArr13[11] == null) {
                C4393util.LOGI("reserve[11] is null", "");
                length2 = 0;
            } else {
                length2 = bArr13[11].length;
            }
            C4393util.LOGI("mainSigMap 0x" + Integer.toHexString(this.mainSigMap) + " file da2 len " + length + " rsp da2 len " + length2, "");
            if (bArr13[11] != null) {
                if (bArr13[11].length > 0) {
                    this._DA2 = (byte[]) bArr13[11].clone();
                    C4393util.LOGI("get _DA2", "");
                } else if ((33554432 & this.mainSigMap) != 0) {
                    this._DA2 = new byte[0];
                    C4393util.LOGI("clear _DA2", "");
                }
            }
            ...
            this.wtSessionTicketCreatTime = C4379u.m72f();
        }
    }
    ...
    public void readFromParcel(Parcel parcel) {
        ...
        this.f5318_G = parcel.createByteArray();
    ...
    public WloginSigInfo setDA2(byte[] bArr) {
        if (bArr == null || bArr.length == 0) {
            C4393util.LOGI("WloginSiginfo.setDA2 da2 0", "");
            this._DA2 = new byte[0];
        } else {
    ...
    public String toString() {
        try {
            ...
            objArr[6] = Integer.valueOf(this.wtSessionTicket != null ? this.wtSessionTicket.length : 0);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByteArray(this.f5318_G);
